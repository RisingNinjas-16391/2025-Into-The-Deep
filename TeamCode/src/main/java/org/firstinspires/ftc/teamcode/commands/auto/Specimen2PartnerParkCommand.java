...
public class Specimen2PartnerParkCommand extends SequentialCommandGroup {
    public Specimen2PartnerParkCommand(DrivetrainSubsystem drive, ElevatorSubsystem elevator, OuttakePivotSubsystem outtakePivot, ClawSubsystem outtakeClaw, ExtendoSubsystem extendo, IntakeSubsystem intake, IntakePivotSubsystem intakepivot) {
        addCommands(
