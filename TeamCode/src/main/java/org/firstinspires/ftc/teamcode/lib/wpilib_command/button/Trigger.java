...
package org.firstinspires.ftc.teamcode.lib.wpilib_command.button;
...
public class Trigger implements BooleanSupplier {
   ...
   * should restart, see {@link org.firstinspires.ftc.teamcode.lib.wpilib_command.RepeatCommand}.
   *
   * @param command the command to start
   * @return this trigger, so calls can be chained
   */
